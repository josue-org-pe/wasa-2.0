...
public class CampoTextoModerno extends JTextField {
    ...
    public CampoTextoModerno(String placeholder, int columns) {
        super(columns);
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isFocused) {
            g2.setColor(Tema.BORDER_ACTIVE);
        ...
        if (getText().isEmpty() && !isFocused && placeholder != null && !placeholder.isEmpty()) {
            ...
            Tema.enableQualityRendering(gPlaceholder);
            gPlaceholder.setColor(Tema.TEXT_MUTED);
