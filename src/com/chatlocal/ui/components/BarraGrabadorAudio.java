...
public class BarraGrabadorAudio extends JPanel {
    ...
    private final ServicioGrabadorAudio recorder;
    ...
    public BarraGrabadorAudio(ServicioGrabadorAudio recorder, AudioRecordCallback callback) {
    ...
    private void buildUI() {
        ...
        BotonModerno btnSend = new BotonModerno("Enviar Audio", Iconos.send(14, Color.WHITE), BotonModerno.Variant.PRIMARY);
    ...
    private void finishAndSend() {
        ...
        ServicioGrabadorAudio.AudioRecordResult result = recorder.stopRecording();
        setVisible(false);
