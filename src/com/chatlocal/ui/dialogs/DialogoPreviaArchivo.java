...
public class DialogoPreviaArchivo extends JDialog {
    ...
    private CampoTextoModerno txtCaption;

    public DialogoPreviaArchivo(Window parent, File file, FilePreviewCallback callback) {
    ...
    private void buildUI() {
        ...
        JPanel centerCard = new JPanel(new BorderLayout(0, 10)) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(GestorTema.getTheme().bgCard);
        ...
        lblSize.setForeground(GestorTema.getTheme().textMuted);
        ...
        txtCaption = new CampoTextoModerno("Añadir un comentario (opcional)...", 20);
        ...
        BotonModerno btnSend = new BotonModerno("Enviar", Iconos.send(14, Color.WHITE), BotonModerno.Variant.PRIMARY);
    ...
    private JPanel createGenericFileCard() {
        ...
        JLabel iconLabel = new JLabel(Iconos.file(48, GestorTema.getTheme().primary));
        panel.add(iconLabel);
        return panel;
    }
