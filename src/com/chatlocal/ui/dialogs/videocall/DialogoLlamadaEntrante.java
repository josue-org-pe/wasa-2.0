...
public class DialogoLlamadaEntrante extends JDialog {
    ...
    public DialogoLlamadaEntrante(Frame parent, ServicioVideollamada callService, String callerName, Runnable onAcceptCallback) {
    ...
    private void buildUI() {
        JPanel card = new JPanel(new BorderLayout(0, 16)) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(GestorTema.getTheme().borderActive);
        ...
        JLabel lblAvatar = new JLabel(Iconos.avatar(callerName, 56, GestorTema.getTheme().primary, Color.WHITE));
        ...
        lblCaller.setForeground(GestorTema.getTheme().textMuted);
        ...
        BotonModerno btnReject = new BotonModerno("Rechazar", Iconos.phoneEnd(16, Color.WHITE), BotonModerno.Variant.DANGER);
        ...
        BotonModerno btnAccept = new BotonModerno("Aceptar", Iconos.phone(16, Color.WHITE), BotonModerno.Variant.SUCCESS);
