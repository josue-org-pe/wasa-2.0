...
public class TemaApp {
    ...
    public TemaApp(String id, String name, Color bgDark, Color bgSidebar, Color bgCard, Color bgCardHover,
    ...
    public static final TemaApp NEON_CYBER = new TemaApp(
    ...
    public static final TemaApp EMERALD_MATRIX = new TemaApp(
    ...
    public static final TemaApp OCEAN_DISCORD = new TemaApp(
    ...
    public static final TemaApp CRIMSON_DARK = new TemaApp(
    ...
    public static final TemaApp SOLAR_LIGHT = new TemaApp(
