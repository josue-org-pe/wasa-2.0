...
public class FuenteCamaraWeb implements FuenteVideo {

    private final String userName;
    private final FuenteCamaraVirtual fallbackVirtual;
    ...
    public FuenteCamaraWeb(String userName) {
        this.userName = (userName != null && !userName.isEmpty()) ? userName : "Usuario";
        this.fallbackVirtual = new FuenteCamaraVirtual(this.userName);
