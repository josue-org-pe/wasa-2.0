...
public class GestorTransmisionMedia {
    ...
    private FuenteVideo currentVideoSource;
    ...
    public GestorTransmisionMedia(FuenteVideo initialSource, MediaFrameConsumer consumer) throws SocketException {
    ...
    public synchronized void setVideoSource(FuenteVideo newSource) {
        if (newSource != null) {
            FuenteVideo old = this.currentVideoSource;
