...
public class UsuarioPerfil implements Serializable {
    ...
    private final RolConexion role;
    ...
    public UsuarioPerfil(String username, RolConexion role, String ipAddress, int port) {
        this(UUID.randomUUID().toString(), username, role, ipAddress, port, generateColor(username));
    }

    public UsuarioPerfil(String id, String username, RolConexion role, String ipAddress, int port, int avatarColorHex) {
        this.id = id;
