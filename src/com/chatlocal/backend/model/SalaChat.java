...
public class SalaChat implements Serializable {
    ...
    public SalaChat(String name, String topic, String accessCode, boolean isMeeting, String createdBy) {
        this(UUID.randomUUID().toString(), name, topic, accessCode, isMeeting, createdBy);
    }

    public SalaChat(String id, String name, String topic, String accessCode, boolean isMeeting, String createdBy) {
        this.id = id;
    ...
    public static SalaChat createDefaultGeneralRoom() {
        return new SalaChat("general", "Sala General", "Canal principal para todos los conectados", "", false, "Sistema");
    }
